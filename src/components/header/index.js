...
const Header = (props) => (
  <div>
    <nav className="navbar">
      <label className="navbar-logo"><a className="navbar-logo-link" href="#">{props.logo}</a></label>
      <input type="checkbox" aria-label="navBar" className="navbar-checkbox" id="navBarCheckBox" />
      <label htmlFor="navBarCheckBox" className="icon"><span aria-hidden="true"><i className="navbar-icon-link"></i></span></label>
